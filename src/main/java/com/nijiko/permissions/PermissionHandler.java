...
public abstract class PermissionHandler {
    ...
    // public abstract void setCacheItem(String world, String player, String
    // permission, boolean data);
    // public abstract Map<String, Boolean> getCache(String world);
    // public abstract boolean getCacheItem(String world, String player, String
    // permission);
    // public abstract void removeCachedItem(String world, String player, String
    // permission);
    ...
    public abstract Set<Group> getParentGroups(String world, String name);
