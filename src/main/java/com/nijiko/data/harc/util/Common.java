...
package com.nijiko.data.harc.util;
...
//                    is.close();
    ...
    public Set getUniqueTokens(String str, String separator) {
        String[] tmpStr = str.split(separator);
        return new HashSet(Arrays.asList(tmpStr));
    }

    public String unQuote(String s) {
        return (s != null && ((s.startsWith("\"") && s.endsWith("\"")) || (s.startsWith("'") && s.endsWith("'")))) ? s = s.substring(1, s.length() - 1) : s;
    }

    public String trimAfter(String line, String delim) {
